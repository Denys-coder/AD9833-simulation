...
// 5. код через заданные промежутки времени меняет значения фазавого регистра и регистра частоты
// 5. сделать нормальный дизайн

// отчет 100 страниц (пояснительная записка)
// презентация в power point
// словестная презентация (доклад/защита)
// диплом должен готов быть к 10 июня (+- несколько дней)
